        ...
        <nav className="hidden md:flex space-x-6 lg:space-x-10">
          {navLinks.map((link) => (
            <motion.a
              ...
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
              className="relative text-gray-200 font-medium px-3 py-2 rounded-lg transition-colors duration-300 hover:text-blue-400 group"
            >
              {link.name}
            ...
            {navLinks.map((link) => (
              <li key={link.name}>
                <motion.a
                  ...
                  onClick={() => setIsOpen(false)}
                  whileHover={{ x: 5 }}
                  className="block text-gray-200 font-medium px-3 py-2 rounded-lg hover:bg-white/10 hover:text-blue-400 transition"
                >
                  {link.name}
                </motion.a>
              </li>
